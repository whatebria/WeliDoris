...
                            // Se establece un tamano fijo para cada panel de pedido
...
                            // Panel de estados y metodo de pago
...
                            
                            // Logica para deshabilitar el checkbox de pagado si el metodo de pago no esta especificado
                            pagadoCheckBox.setEnabled(!pagado && !"No especificado".equals(metodoPago));
                            
...
                                        // --- AQUÍ SE AGREGA LA LLAMADA PARA REFRESCAR LOS TOTALES ---
...
                            // La siguiente linea ha sido comentada para permitir la modificacion del metodo de pago.
...
                                        // Ahora el checkbox de pagado se habilita tan pronto como se selecciona un metodo de pago,
                                        // y el combobox permanece habilitado.
                                        pagadoCheckBox.setEnabled(true);
                                    } catch (SQLException ex) {
                                        LOGGER.log(Level.SEVERE, "Error al actualizar el metodo de pago del pedido.", ex);
                                        JOptionPane.showMessageDialog(PedidosGuardadosPanel.this, "Error al actualizar el metodo de pago: " + ex.getMessage(), "Error de Base de Datos", JOptionPane.ERROR_MESSAGE);
                                    }
                                } else {
                                     // Si el metodo de pago se vuelve a poner en "No especificado", se deshabilita el checkbox de pagado.
                                    pagadoCheckBox.setEnabled(false);
                                }
                            });
                            
...
                            estadoPanel.add(new JLabel("Metodo:"));
